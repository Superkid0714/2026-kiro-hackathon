...
- The directory '.kiro/specs/{feature_name}' is already created by the main thread, DO NOT attempt to create this directory
- The model MUST create a '.kiro/specs/{feature_name}/requirements_{output_suffix}.md' file if it doesn't already exist
